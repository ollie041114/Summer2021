...
contract User {
    ...
    constructor (string memory _name, string memory _surname, uint _id, address _eth_address, bool _isCurator, address UNICOINaddress) {
        UserInfo = abstractUserInfo(_name, _surname, _id, _eth_address, _isCurator, true);
